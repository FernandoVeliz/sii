...
if($lastInsertId)
{
$msg="Se registró al alumno exitosamente";
}
else 
{
$error="Hubo un error, favor de intentar nuevamente";
}
...
<html lang="en">
    <head>
        ...
        <title>SII | Registro de Alumno< </title>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Llene la información del alumno</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Número de control</label>
<div class="col-sm-10">
...
<div class="col-sm-10">
<input type="radio" name="gender" value="Male" required="required" checked="">Masculino <br><input type="radio" name="gender" value="Female" required="required">Femenino
</div>
</div>
