                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">Sistema Integral de Información</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Calificaciones del alumno</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
{   ?>
<p><b>Nombre del alumno:</b> <?php echo htmlentities($row->StudentName);?></p>
<p><b>Número de control:</b> <?php echo htmlentities($row->RollId);?>
<p><b>Grupo del alumno:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
...
?>
<tr>
<th scope="row" colspan="2" style="text-align: center">Calificación final</th>
...
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Alerta!</strong> Aún no se encuentran calificaciones en el sistema
 <?php }
?>
                                        </div>
 <?php 
