...
<html lang="en">
    <head>
        ...
        <title>SII Actualizar Grupo</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Actualizar Grupo</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Actualizar Grupo</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Actualizar información del grupo</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Grupo (número)</label>
                                                        <div class="">
