...
if($lastInsertId)
{
$msg="Se añadieron las calificaciones exitosamente";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <title>SII | Añadir Calificaciones </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Añadir Calificaciones</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Añadir Calificaciones</li>
                                    </ul>
                                </div>
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Nombre del Alumno</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Añadir Calificaciones</button>
                                                        </div>
                                                    </div>
                                                </form>
