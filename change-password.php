...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Excelente!</strong><?php echo htmlentities($msg); ?>
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Cambiar contraseña<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
